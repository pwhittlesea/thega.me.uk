...
# From https://www.statichost.eu/shcli

set -euo pipefail

# Check arguments
if [ $# -ne 2 ]; then
    echo "Usage: $0 <site-name> <directory>"
    echo "Example: $0 my-site ./dist"
    exit 1
fi
...
if [ -z "${STATICHOST_APIKEY:-}" ]; then
    ...
    echo ""
    echo "Please go to https://builder.statichost.eu/account to create an API token"
    echo "Then set it as an environment variable, e.g.:"
    echo "  export STATICHOST_APIKEY=your_token_here"
    echo ""
