---
title: I visited South Korea - Part 1
date: 2026-06-06
categories: [holidays]
tags : ["south korea"]
series: ["South Korea"]
...
summary: "So the destination for this year's 'big holiday' &mdash; which we are blessed to be able to do every two years &mdash; is South Korea!"

maps:
  - name: map_london_to_seoul
    line: true
    points:
      ...
      - name: Seoul - Incheon
        lat: 37.45940
        lon: 126.43714
  - name: map_seoul_to_hanok
    points:
      - name: Incheon Airport
        lat: 37.45940
        lon: 126.43714
      - name: Hotel - Staymoire
        lat: 37.576597440049646
        lon: 126.99126809504023
  - name: map_hanok_to_myeongdong
    points:
      - name: Hotel - Staymoire
        lat: 37.576597440049646
        lon: 126.99126809504023
      - name: Myeongdong Market
        lat: 37.56185557571249
        lon: 126.9858545248172
  - name: map_myeongdong_to_forest
    points:
      - name: Myeongdong Market
        lat: 37.56185557571249
        lon: 126.9858545248172
      - name: Seoul Forest
        lat: 37.54459646087353
        lon: 127.03934378912784
  - name: map_hanok_to_853
    points:
      - name: Hotel - Staymoire
        lat: 37.576597440049646
        lon: 126.99126809504023
...
This is my third swing at travel blogging after I went to [New Zealand]({{< ref "2024-09-15-new-zealand-1" >}}) back in May 2024, and [Italy]({{< ref "2025-11-02-monopoli" >}}) last year.
...
{{< mm-gallery id="premium-economy" caption="The perks of Premium Economy" >}}
...
![A box of 6 sushi maki with a spicy sauce and a mini Magnum ice cream sit on the tray table in an aeroplane](south_korea_2565.jpg "Sushi and an Ice Cream")
{style="width:50%;" class="items-center mx-auto text-center"}

I spent most of my time reading, finishing {{< book "Muse of Nightmares" "7aab9b33-5787-48cf-9288-174cd37e331a" >}} and getting most of the way through {{< book "The Undermining of Twyla and Frank" "ab21ee37-b4ae-45d0-8b7b-1753fb832c5d" >}}.
Both very good books I will probably call out in my [end of year round up]({{< ref "2025-12-28-a-year-in-review-2025-books" >}}).
...
{{< map name="map_seoul_to_hanok" google="false" >}}
...
![A wooden gate and a sign saying 'Stay miore' and behind it a short path with bamboo either side leads to a wooden door](south_korea_2821.jpg "The Entrance to Stay moire")
{style="width:50%;" class="items-center mx-auto text-center"}
...
![A white dish on a wooden table with breaded chicken cutlets on a spicy red sauce](south_korea_2568.jpg "Chicken & Tteokbokki")
{style="width:50%;" class="items-center mx-auto text-center"}
...
![A picture overlooking the central courtyard of a Hanok](featured.jpg "The Courtyard")
{style="width:50%;" class="items-center mx-auto text-center"}
...
![A cup of ice, Hazelnut Coffee, and Banana Milk on a wooden table](south_korea_8788.jpg "A cup of ice, Hazelnut Coffee, and Banana Milk")
{style="width:50%;" class="items-center mx-auto text-center"}
...
{{< youtubeLite id="v3VB4MN4lh4" label="Slow-motion Banana Milk" params="controls=0" >}}
...
![Two people holding up battered hot dogs on sticks. In the background the sun is shining on a courtyard](south_korea_2572.jpg "Battered Hot dogs")
{style="width:50%;" class="items-center mx-auto text-center"}
...
{{< map name="map_hanok_to_myeongdong" google="false" >}}
...
![A pink payment card with a hole for a SIM card in it](south_korea_3329.jpg "A T-Money Card")
{style="width:50%;" class="items-center mx-auto text-center"}
...
{{< youtubeLite id="kc177DPQnsU" label="The sounds of the Seoul Subway" params="controls=0" >}}
...
{{< mm-gallery id="myeongdong-shops" caption="Fun stores in Myeongdong Market" >}}
...
{{< mm-gallery id="myeongdong-streets" caption="The streets of Myeongdong" >}}
...
![A round magsafe charger lying on a wooden table that looks like a butter biscuit](south_korea_charger.jpg "A 'magsafe' charger and pop-socket")
{style="width:50%;" class="items-center mx-auto text-center"}
...
{{< map name="map_myeongdong_to_forest" google="false" >}}
...
{{< mm-gallery id="seoul-forest" caption="Nature at Seoul Forest" >}}
...
![A natural archway with three Pikachu on with the text 'Pokémon Secret Forest' on it](south_korea_pokemon_forest.jpg "The Entrance to the Pokémon Secret Forest")
{style="width:50%;" class="items-center mx-auto text-center"}
...
{{< map name="map_hanok_to_853" google="false" >}}
...
![Many plates with food sitting on a wooden table with an open grill plate in the middle](south_korea_2605.jpg "Our first Korean BBQ")
{style="width:50%;" class="items-center mx-auto text-center"}
...
Tomorrow we were signed up for a tour of the North/South Korean {{< term "DMZ" >}}.\
See you in part 2!
