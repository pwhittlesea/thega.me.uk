---
title: Exploring Gyeongju and Busan
date: 2026-07-25
categories: [holidays]
tags : ["south korea"]
series: ["South Korea"]
...
summary: "Now settled in Busan, we explore the Three Kingdoms Capital, before we fly to our next destination."

galleries:
  bulguksa_temple:
    - image_path: south_korea_15_123148.webp
      title: The Cheongungyo (Blue Cloud Bridge)
      alt: Stone steps lead up to a traditional Korean building
    - image_path: south_korea_15_123322.webp
      title: An overly dramatic door
      alt: A red door in a five-foot stone wall covered by a tiled awning
    - image_path: south_korea_15_130911.webp
      title: A very large bell
      alt: A large weathered bell hanging in a wooden building with red pillars and a painted ceiling
  gyeongju_gyochon:
    - image_path: south_korea_15_152315.webp
      title: A traditional Korean house with a small garden
      alt: A dry dirt garden with several trees and plants sits infront of a traditional building with a dirt courtyard
    - image_path: south_korea_15_155010.webp
      title: Modern meets tradition
      alt: A traditional korean building with two air-conditioners has a tree and woman in a swing painted on its side
  daereungwon_tomb:
    - image_path: south_korea_15_165153.webp
      title: The mound the tomb is in
      alt: A rounded hill with a sign in front of it
    - image_path: south_korea_15_165515.webp
      title: The main coffin of the tomb
      alt: An old wooden coffin with gold regalia inside a glass room
  donggung_palace:
    - image_path: south_korea_15_184711.webp
      title: The pavillion overlooking the pond
      alt: A red wooden pavillion on a stone base overlooks a stagnant pond with trees surrounding it
    - image_path: south_korea_15_185331.webp
      title: The pavillions overlooking the pond
      alt: Two red wooden pavillions on stone bases overlook a stagnant pond with trees surrounding it
  donggung_palace_sunset:
    - image_path: south_korea_15_190111.webp
      title: A view out over neighbouring rice paddies as the sun sets
      alt: The sun setting over a mountain with rice paddies in the foreground
    - image_path: south_korea_15_191025.webp
      title: The pavillion at sunset
      alt: A red wooden pavillion on a stone base overlooks a pond with an orange sky at sunset
  woljeonggyo_bridge:
    - image_path: south_korea_15_194749.webp
      title: Woljeonggyo Bridge during blue hour
      alt: A traditional wooden bridge at night with lights illuminating the underside of the structure
  haeundae_sunrise:
    - image_path: south_korea_16_052210.webp
      title: Sunrise over Haeundae beach
      alt: Sun rises in the distance behind two high-rise buildings
  haeundae_sand_festival:
    - image_path: south_korea_16_055748.webp
      title: Sand art of the Little Prince
      alt: A sand sculpture with a representation of the Little Prince with the ocean in the background
    - image_path: south_korea_16_132547.webp
      title: Sand art of landmarks around Busan
      alt: A sand sculpture with images depicting landmarks around Busan with a walkway over the top
    - image_path: south_korea_16_132902.webp
      title: "Sand art of Avatar: The Way of Water"
      alt: "A sand sculpture with a representation of a character from Avatar: The Way of Water with the ocean in the background"

maps:
  - name: map_hotel_to_bulguksa
    points:
    - name: Our Hotel
      lat: 35.1601498896712
      lon: 129.1600650330206
    - name: Bulguksa Temple
      lat: 35.790107695967784
      lon: 129.33181574065094
  - name: map_bulguksa_to_gyeongju
    points:
    - name: Bulguksa Temple
      lat: 35.790107695967784
      lon: 129.33181574065094
    - name: Gyeongju Gyochon
      lat: 35.82969634599336
      lon: 129.21481906831045
  - name: map_gyeongju_to_daereungwon
    points:
    - name: Gyeongju Gyochon
      lat: 35.82969634599336
      lon: 129.21481906831045
    - name: Daereungwon Tomb
      lat: 35.838232543575536
      lon: 129.21079913947543
  - name: map_daereungwon_to_donggung
    points:
    - name: Daereungwon Tomb
      lat: 35.838232543575536
      lon: 129.21079913947543
    - name: Donggung Palace
      lat: 35.834904252043096
      lon: 129.22653231064
  - name: map_donggung_to_woljeong
    zoom: 15
    points:
    - name: Donggung Palace
      lat: 35.834904252043096
    ...
    - name: Woljeonggyo Bridge
      lat: 35.82922130039673
      lon: 129.21811844973632
  - name: map_drone_show
    points:
    - name: Our Hotel
      lat: 35.1601498896712
      lon: 129.1600650330206
    - name: Drone Show
      lat: 35.15523676576342
      lon: 129.12246429530154
  - name: map_flight_to_jeju
    line: true
    points:
    - name: Busan
      lat: 35.1601498896712
      lon: 129.1600650330206
    - name: Jeju Island
      lat: 33.2462485111808
      lon: 126.56008846445748
---
...
In [part 4]({{< ref "2026-07-08-a-train-to-busan" >}}) we waved goodbye to Seoul and went on a whimsical tour of Busan.

This time we explore the Three Kingdoms Capital to the north-east, and leave for our next location.

## 15^th^ May: Gyeongju Tour

If you remember, [yesterday]({{< ref "2026-07-08-a-train-to-busan#14th-may-seaside-tour" >}}) we did a seaside tour, and whilst we were on the coach back, we considered that we had no plans for tomorrow (today).
...
![The inside of a building with stone steps leading to a small hut with a waterwheel next to it](south_korea_15_100825.webp "The inside of Standard Bread")
...
It was at this point that my decision to [go to an Indian restaurant]({{< ref "2026-07-08-a-train-to-busan#night-market" >}}) last night, became a very poor choice.
...
![Plastic designed to look like dark carved wood runs the length of a coach ceiling, adored with red and green LEDs](south_korea_15_110024.webp "Every coach had a unique interior")
{style="width:50%;" class="items-center mx-auto text-center"}
...
{{< map name="map_hotel_to_bulguksa" google="false" >}}
...
{{< mm-gallery id="bulguksa_temple" caption="Bulguksa Temple" >}}
...
![A spiky caterpillar sat on a stack of grey rocks](south_korea_15_130610.webp "Spiky freinds")
{style="width:50%;" class="items-center mx-auto text-center"}
...
{{< map name="map_bulguksa_to_gyeongju" google="false" >}}

Like previous [cultural villages]({{< ref "2026-06-24-dressing-up-at-gyeongbokgung#12th-may-eunpyeong-hanok-village" >}}) we had been to, there were lots of similarities.
...
{{< mm-gallery id="gyeongju_gyochon" caption="Gyeongju Gyochon Traditional Village" >}}
...
![A purple phallic-shaped Injeolmi rice cake sits on ice-cream on a metal bowl](south_korea_15_155519.webp "_Interesting_ Ice Cream")
{style="width:50%;" class="items-center mx-auto text-center"}
...
[Woljeonggyo Bridge]({{< ref "#woljeong-bridge" >}}) was just over the road, so we would be coming back here later tonight.

### Daereungwon

Next up, was more 'free time' with a suggested visit to a tomb.

{{< map name="map_gyeongju_to_daereungwon" google="false" >}}
...
{{< mm-gallery id="daereungwon_tomb" caption="Daereungwon Tomb" >}}
...
{{< map name="map_daereungwon_to_donggung" google="false" >}}
...
{{< mm-gallery id="donggung_palace" caption="Donggung Palace & Wolji Pond" >}}
...
{{< mm-gallery id="donggung_palace_sunset" caption="Donggung Palace at Sunset" >}}
...
{{< map name="map_donggung_to_woljeong" google="false" >}}
...
![People taking pictures stand on stepping stones over a river](south_korea_15_194318.webp "Balance for that Instagram shot")
{style="width:50%;" class="items-center mx-auto text-center"}
...
{{< mm-gallery id="woljeonggyo_bridge" caption="Woljeonggyo Bridge" >}}
...
Those of you who suffer from {{< term "FOMO" >}} will struggle with this, but I do not suffer such an affliction, so when my other half asked if I would like to go watch the sunrise over Haeundae beach, I said I'd rather sleep in.

{{< mm-gallery id="haeundae_sunrise" caption="Haeundae Sunrise" >}}
...
{{< mm-gallery id="haeundae_sand_festival" caption="Haeundae Sand Festival" >}}

I have to mention my favourite sighting of Busan's mascot, Boogi, outside the tourist information centre.

![A lamppost with a sticker of a seagull with glasses holding a younger seagull](south_korea_16_132957.webp "Boogi")
{style="width:50%;" class="items-center mx-auto text-center"}
...
{{< map name="map_drone_show" google="false" >}}
...
![A cat-jack-in-a-box hangs in the sky over a bridge while people look on from a beach](south_korea_16_200810.webp "Busan Drone Show")
{style="width:50%;" class="items-center mx-auto text-center"}
...
{{< youtubeLite id="wXP-rgyxu7c" params="rel=0" >}}
...
{{< youtubeLite id="rEOyoFBpejY" params="rel=0" >}}
...
![A giant concrete pillar wrapped in a giant orange chevron, with a reflective diamond, and a danger sign, with multiple chunks taken out of it](south_korea_17_171246.webp "How many warning lights do you need?")
{style="width:50%;" class="items-center mx-auto text-center"}
...
{{< map name="map_flight_to_jeju" google="false" >}}
...
![A welcome to Jeju sign with stone statues either side of it](south_korea_17_203557.webp "Welcome to Jeju")
{style="width:50%;" class="items-center mx-auto text-center"}
