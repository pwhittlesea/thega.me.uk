...
summary: "Day 3 of our South Korean getaway and we take a tour to see the Korean DMZ, and learn more about the war."

maps:
  - name: map_suspension_bridge
    points:
      - name: Hotel
        lat: 37.576597440049646
        lon: 126.99126809504023
      - name: Majang Lake Suspension Bridge
        lat: 37.776348136353946
        lon: 126.92658978774152
  - name: map_defector_lunch
    points:
      - name: Majang Lake Suspension Bridge
        lat: 37.776348136353946
        lon: 126.92658978774152
      - name: Haengbok Restaurant
        lat: 37.83937541136884
        lon: 126.78027632873071
  - name: map_freedom_bridge
    points:
      - name: Haengbok Restaurant
        lat: 37.83937541136884
        lon: 126.78027632873071
      - name: Imjingak Resort
        lat: 37.88996987522438
        lon: 126.73881246878439
  - name: map_third_tunnel
    points:
      - name: Imjingak Resort
        lat: 37.88996987522438
        lon: 126.73881246878439
      - name: Third Tunnel
        lat: 37.916695261773555
        lon: 126.69836819015973
  - name: map_dora_observatory
    points:
      - name: Third Tunnel
        lat: 37.916695261773555
        lon: 126.69836819015973
      - name: New Dora Observatory
...
In [part 1]({{< ref "2026-06-06-south-korea-1" >}}) we had arrived in Korea after a sleepless flight (for me at least) and had spent our second day mooching around the city, getting familiar with things like the Seoul Subway, and 7-Elevens.
...
From the mental pictures I had of the {{< term "DMZ" >}}, and it's description, I had made the assumption it was this barren World War One-style no-mans land; but I could not have been more wrong.
...
The {{< term "DMZ" >}} is a military controlled space, and as such, we needed to prove who we were prior to entering, and on the way back out.

Miraculously, for a group of 40 adults, we all managed to remember them.

Tourist numbers in the {{< term "DMZ" >}} are controlled, and our appointment was later that afternoon.
So, before we get to the {{< term "DMZ" >}}, there were a few stops beforehand.

### Majang Lake Suspension Bridge

First up, was something completely unrelated; a lovely bridge over a lovely lake.

{{< map name="map_suspension_bridge" google="false" >}}
...
![A narrow bridge across a blue-green lake with trees on the far side](south_korea_2633.webp "The Majang Lake Suspension Bridge")
...
{{< mm-gallery id="suspension-bridge" caption="The beautiful views across the lake" >}}
...
{{< map name="map_defector_lunch" google="false" >}}
...
Once we had all had our fill, we could finally head towards the {{< term "DMZ" >}}.

### Imjingak Resort

First up on our tour of the {{< term "DMZ" >}}, was the [Imjingak resort](https://en.wikipedia.org/wiki/Imjingak).

{{< map name="map_freedom_bridge" google="false" >}}

Sitting so close to the {{< term "DMZ" >}}, that getting lost on the way to the toilet might cause a diplomatic incident, Imjingak houses lots of memorials and an educational centre for the Korean War.
...
Our 50-year-old guide, Cindy, who had to get our passes for the {{< term "DMZ" >}}, proceeded to leap from the coach like a gazelle, and run across the car park to the visitor centre, reminding me again that I am completely out of shape for my age[^2].
...
{{< mm-gallery id="freedom-bridge" forced_layout="tw:grid-cols-4" caption="Imjingak memorials" >}}
...
Our visit was fleeting however, as we had an appointment with the {{< term "DMZ" >}} border guard.

### The Third Tunnel

Remember me saying the {{< term "DMZ" >}} is a military controlled space?
...
![A notification on a phone showing an emergency alert in Korean](south_korea_2618.webp "An emergency alert")
{style="width:50%;" class="items-center mx-auto text-center"}
...
This is where my pre-conceived notion that the {{< term "DMZ" >}} would be a wasteland evaporated [^3].
...
![Fields of Rice Paddies](south_korea_2640.webp "Rice Paddies on the way to the DMZ")
{style="width:50%;" class="items-center mx-auto text-center"}

We only had two destinations inside the {{< term "DMZ" >}}, the first was _'The Third Tunnel of Aggression'_ ([Google](https://maps.app.goo.gl/ocVBqkM3QbPeq1XGA), [Naver](https://naver.me/F05Qedqz)).

{{< map name="map_third_tunnel" google="false" >}}
...
![A multicoloured sign of the letters 'DMZ' in front of a monorail station](featured.webp "The sign at the center of the DMZ")
{style="width:50%;" class="items-center mx-auto text-center"}
...
![Shelves containing hard-hats line the walls of a corridor that has a steep decline](external_third_tunnel_entrance.webp "\"[Third Tunnel of Aggression](https://www.flickr.com/photos/tyrian123/3391982738)\" by [JoshBerglund19](https://www.flickr.com/photos/tyrian123/) [CC BY 2.0](https://creativecommons.org/licenses/by/2.0/deed.en)")
{style="width:50%;" class="items-center mx-auto text-center"}
...
We were able to walk 265 meters to the '3^rd^ blockade', which lay 170 meters from the Military Demarcation Line (the middle of the {{< term "DMZ" >}}).
...
{{< youtubeLite id="TxZE8RYOlkI" params="start=58&rel=0" >}}
...
{{< mm-gallery id="dmz-park" caption="A park behind the Third Tunnel" >}}
...
{{< map name="map_dora_observatory" google="false" >}}
...
{{< mm-gallery id="dora-observatory" caption="The front of the New Dora Observatory">}}
...
![Two pairs of binoculars on poles look out over a misty landscape](external_dora_observatory.webp "\"[DMZ (7)](https://www.flickr.com/photos/kucinski/4683729305)\" by [Ben Kucinski](https://www.flickr.com/photos/kucinski/) [CC BY 2.0](https://creativecommons.org/licenses/by/2.0/deed.en)")
{style="width:50%;" class="items-center mx-auto text-center"}

My other half temporarily became a South Korean spy by pointing out to our tour guide a glint from a forest on the North Korean side of the {{< term "DMZ" >}}.
Cindy took them to talk to a South Korean Soldier who said (and I paraphrase), "North Korea is up to something".

Espionage complete, we headed back to the coach, and back out of the {{< term "DMZ" >}}.
